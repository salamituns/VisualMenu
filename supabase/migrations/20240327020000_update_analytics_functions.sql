...
drop function if exists get_analytics_summary(timestamp);
drop function if exists get_sales_data(timestamp);
drop function if exists get_menu_item_performance(timestamp);
drop function if exists get_customer_data(timestamp);
